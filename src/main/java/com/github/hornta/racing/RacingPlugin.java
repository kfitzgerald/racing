...
public class RacingPlugin extends JavaPlugin {
	...
	private void setupMessages() throws MessengerException {
		...
		m.add(MessageKey.RACE_RESPAWN_SUCCESS, "commands.race_respawn.success");
		m.add(MessageKey.RACE_RESPAWN_NOT_PARTICIPATING, "commands.race_respawn.error_not_participating");
	...
	private void setupCommands() {
		...
		commando.addCommand("racing respawn").withHandler(new CommandRespawn(racingManager)).requiresPermission(Permission.COMMAND_RESPAWN.toString()).requiresPermission(Permission.RACING_PLAYER.toString()).preventConsoleCommandSender();
